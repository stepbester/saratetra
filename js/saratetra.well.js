 ...
 */
function DebrisBlock(blockColour) {
...
Well.prototype.draw = function(context) {
	// Border
...
Well.prototype.applyGravity = function() {
	if (this.fallingPiece) {
...
Well.prototype.animateEnding = function(step) {
...
Well.prototype.freezePiece = function() {
	// Create debris
...
Well.prototype.eliminateRows = function() {
...
Well.prototype.insertPiece = function(tetromino) {
	// Position the piece
...
Well.prototype.rotatePiece = function() {
...
Well.prototype.steerPieceLeft = function() {
	// Can only move in the falling phase
	if (this.state != WellState.PIECE_FALLING) {
		return;
	}
...
Well.prototype.steerPieceRight = function() {
	// Can only move in the falling phase
	if (this.state != WellState.PIECE_FALLING) {
		return;
	}
...
Well.prototype.collidesBelow = function(col, row, piece) {
...
Well.prototype.collidesLeft = function(col, row, piece) {
	var blocks = piece.getBlocks();
...
Well.prototype.collidesRight = function(col, row, piece) {
	var blocks = piece.getBlocks();
...
Well.prototype.overlaps = function(col, row, piece) {
	var blocks = piece.getBlocks();
